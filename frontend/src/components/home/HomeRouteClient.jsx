...
function HomeSkeleton() {
  return <main className="min-h-screen overflow-x-hidden bg-[var(--background)]" aria-busy="true">
    <section className="border-b border-[var(--border)] bg-[var(--primary-soft)]"><div className="mx-auto grid max-w-7xl gap-8 px-4 py-14 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-20"><div className="animate-pulse"><div className="h-4 w-40 rounded bg-[var(--primary-border)]" /><div className="mt-5 h-12 max-w-xl rounded bg-[var(--skeleton)]" /><div className="mt-3 h-5 max-w-lg rounded bg-[var(--skeleton)]" /></div><div className="hidden h-72 rounded-[2rem] bg-[var(--skeleton)] lg:block" /></div></section>
